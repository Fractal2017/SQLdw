...
/opt/mssql-tools/bin/sqlcmd -S localhost -U sa -P SqlDevOps2017 -i ./create-db.sql
/opt/mssql-tools/bin/sqlcmd -S localhost -U sa -P SqlDevOps2017 -i ./restoreAdvWrks.sql
